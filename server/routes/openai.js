...
import dotenv from "dotenv"; // to use environment variables, which need to be configured for each file
...
router.post("/assist", async (req, res) => {
  try {
    ...
    const response = await openai.chat.completions.create({
      model: "gpt-3.5-turbo",
      messages: [
        { role: "system", content: "Hello!" }, // this represents the bot and what role they will assume
